...
$json = Get-Content -Path "..\media-lifestyle-apps\projects\series-movies\src\version.json" -Raw -Encoding UTF8
...
Set-Content -Path "..\media-lifestyle-apps\projects\series-movies\src\version.json" -Value $json -Encoding UTF8
