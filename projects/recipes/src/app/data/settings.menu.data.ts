...
export const SETTINGS_MENU: Menu<SettingsMenu, SettingsMenuKey>[] = [
  {
    key: SettingsMenuKey.APPLICATION,
    name: SettingsMenu.APPLICATION,
    icon: "screen",
  },
  {
  ...
  { name: SettingsMenu.SEPARATOR },
  {
    key: SettingsMenuKey.SPECIFIC_CONVERSIONS,
    name: SettingsMenu.SPECIFIC_CONVERSIONS,
    icon: "ingredient-conversion",
  },
  {
    key: SettingsMenuKey.SPECIFIC_UTENSILS,
    name: SettingsMenu.SPECIFIC_UTENSILS,
    icon: "utensil",
  },
  { name: SettingsMenu.SEPARATOR },
  {
